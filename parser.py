...
if __name__ == '__main__':
    ...
    schema = DataFrameSchema({
        "nom_amenageur": Column(str, nullable=True),
        ...
        "implantation_station": Column(str, Check.str_matches(r'(Voirie|Parking public|Parking privé à usage public|Parking privé réservé à la clientèle|Station dédiée à la recharge rapide){1}')),
        ...
        "accessibilite_pmr": Column(str, Check.str_matches(r'(Réservé PMR|Accessible mais non réservé PMR|Non accessible|Accessibilité inconnue){1}')),
    ...
    try:
        schema.validate(file, lazy=True)
